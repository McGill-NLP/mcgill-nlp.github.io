...
| 4 | Sep 9 | Word embeddings (cont..), Bias (McGill NLP: [Nicolas Meade](https://ncmeade.github.io/)) |  | [Enriching Word Vectors with Subword Information](https://arxiv.org/abs/1607.04606), [Man is to Computer Programmer as Woman is to Homemaker?](https://arxiv.org/abs/1607.06520), [Semantics derived automatically from language corpora contain human-like biases](https://arxiv.org/abs/1608.07187) |   |
| 5 | Sep 11 | Sentence Representations (CNN, RNN, LSTMs) |  |  |   |
| 6 | Sep 16 | LSTMs, Backpropagation through time (McGill NLP: Arisides Milios) |  |  |   |
