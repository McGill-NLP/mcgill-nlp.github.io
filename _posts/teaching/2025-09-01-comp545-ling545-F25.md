...
**Quizzes (20%)**  
  * Three same-day take-home quizzes (best 2 out of 3, each worth 10%)  
...
| 3 | Sep 4 | Word Embeddings |  | [Distributed Representations of Words and Phrases and their Compositionality](https://proceedings.neurips.cc/paper/2013/file/9aa42b31882ec039965f3c4923ce901b-Paper.pdf), [Neural Word Embedding as Implicit Matrix Factorization](https://papers.nips.cc/paper/2014/file/feab05aa91085b7a8012516bc3533958-Paper.pdf) |   |
| 4 | Sep 9 | Word embeddings (cont..), Bias  | Sep 9: Assignment 1 release | [Enriching Word Vectors with Subword Information](https://arxiv.org/abs/1607.04606), [Man is to Computer Programmer as Woman is to Homemaker?](https://arxiv.org/abs/1607.06520), [Semantics derived automatically from language corpora contain human-like biases](https://arxiv.org/abs/1608.07187) |   |
