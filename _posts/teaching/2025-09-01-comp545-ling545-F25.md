...
| 4 | Sep 9 | Word embeddings (cont..), Bias  | Sep 4: Assignment 1 release | [Enriching Word Vectors with Subword Information](https://arxiv.org/abs/1607.04606), [Man is to Computer Programmer as Woman is to Homemaker?](https://arxiv.org/abs/1607.06520), [Semantics derived automatically from language corpora contain human-like biases](https://arxiv.org/abs/1608.07187) |   |
